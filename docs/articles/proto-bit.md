...
Причём сам **базис** в физическом смысле тоже можно рассматривать как **ещё один прото-бит** — физическую конфигурацию, относительно которой мы будем проводить различение. И только **взаимодействие двух прото-битов** (состояния системы и состояния базиса) создаёт **1 бит информации**: акт сравнения, в котором устанавливается бинарное значение.

Пример из физики: квантовая запутанность. До измерения состояние одной частицы не является «0» или «1» — оно описывается вектором в пространстве состояний. «0» или «1» появляются только при выборе базиса (второго прото-бита) и акте измерения (сравнении).
